	...
	where T : unmanaged, IBinaryInteger<T>
{
	...
	public IEnumerable<Point3D<T>> CornerPoint
	{
		get
		{
			yield return new Point3D<T>(XRange.Start, YRange.Start, ZRange.Start);
			yield return new Point3D<T>(XRange.Start, YRange.Start, ZRange.End);
			yield return new Point3D<T>(XRange.Start, YRange.End, ZRange.Start);
			yield return new Point3D<T>(XRange.Start, YRange.End, ZRange.End);
			yield return new Point3D<T>(XRange.End, YRange.Start, ZRange.Start);
			yield return new Point3D<T>(XRange.End, YRange.Start, ZRange.End);
			yield return new Point3D<T>(XRange.End, YRange.End, ZRange.Start);
			yield return new Point3D<T>(XRange.End, YRange.End, ZRange.End);
		}
	}
	...
	/// <inheritdoc />
	public static bool operator ==(Cuboid<T> left, Cuboid<T> right)
	{
