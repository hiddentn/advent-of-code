	...
	where T : unmanaged, INumber<T>
{
	...
	///     a vector whose <see cref="X" /> component is <see cref="T.One" /> and all other components are all
	///     <see cref="T.Zero" />.
	/// </summary>
	...
	///     a vector whose <see cref="Y" /> component is <see cref="T.One" /> and all other components are all
	///     <see cref="T.Zero" />.
	/// </summary>
	...
	///     a vector whose <see cref="Z" /> component is <see cref="T.One" /> and all other components are all
	///     <see cref="T.Zero" />.
	/// </summary>
	...
	///     a vector whose <see cref="W" /> component is <see cref="T.One" /> and all other components are all
	///     <see cref="T.Zero" />.
	/// </summary>
